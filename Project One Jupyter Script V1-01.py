...
# ---- TODO: make your edits here ----
stderr = stdev/(n ** 0.5)
conf_int_95 = st.norm.interval(.99, mean, stderr)
...
# choice1 = st.norm.sf
choice2 = st.norm.cdf(108, loc=96, scale=12)
...
# Mean relative skill of all teams from the years 2013-2015
# mean = your_years_leagues_df['elo_n'].mean()
# Mean relative skill of all teams from the years 1996 through 1998
...
print("\n")
print("Python Method to calculate probability that a team has Average Relative Skill LESS than the Average Relative Skill (ELO) of your team in the years 1996 to 1998")
print("----------------------------------------------------------------------------------------------------------------------------------------------------------")

#choice1 = st.norm.sf
#choice2 = st.norm.cdf
choice2 = st.norm.cdf(106, loc=95, scale=11)
